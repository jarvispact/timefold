...
const run = async () => {
    ...
    const gltfJson = await fetch('./plane-interleaved.gltf').then((res) => res.text());
                    ...
                    const buffers: RenderTreeBuffers =
                        primitive.type === 'non-interleaved'
                            ? {
                                  ...
                                  tangent: NonInterlevedVertexLayout.createBuffer(
                                      device,
                                      'tangent',
                            ...
                            : {
                                  type: 'interleaved',
                                  vertices: InterleavedVertexLayout.createBuffer(device, primitive.vertices),
                                  index,
                              };
